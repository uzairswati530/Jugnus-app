  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Total Bookings', value: totalBookings, icon: <Calendar size={20} />, color: 'text-blue-600' },
          { label: 'Total Walk-ins', value: totalWalkIns, icon: <Users size={20} />, color: 'text-amber-600' },
          { label: 'Currently In Chair', value: inChair, icon: <Scissors size={20} />, color: 'text-[#C5A044]' },
          { label: 'Completed Today', value: completed, icon: <CheckCircle size={20} />, color: 'text-green-600' },
        ].map(stat => (
