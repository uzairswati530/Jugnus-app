...
export default function PointsAwardPopup({
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="card p-6 max-w-sm mx-4 rounded-lg space-y-5 animate-in fade-in zoom-in">
        ...
        <div className="text-center space-y-2">
          <h3 className="text-lg font-bold text-white">Award Loyalty Points?</h3>
        ...
        <div className="card-2 p-4 rounded-lg text-center space-y-1">
          ...
          <p className="text-3xl font-bold text-primary">+{pointsToAward.toLocaleString()}</p>
